...
# ---------- CONFIGURATION ----------
KEYWORDS = ["Nike", "Carhartt", "Ralph Lauren", "Funko Pop", "sneakers", "Longchamp", "maillots de football", "the north face", "Patagonia", "stone island", "Arc'teryx", "eastpak", "Lacoste","Stüssy"]
PRICE_MIN = 0
PRICE_MAX = 30
