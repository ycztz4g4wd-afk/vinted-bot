...
KEYWORDS = ["Nike", "Carhartt", "Ralph Lauren", "Funko Pop", "sneakers", "Longchamp", "the north face", "Patagonia", "stone island", "Arc'teryx", "eastpak", "Stussy", "Lacoste"]
PRICE_MIN, PRICE_MAX, SEEN_FILE = 0, 30, "seen_items.json"
MAX_PRICE_RATIO, MIN_PROFIT_EUR, MIN_COMPARABLES = 0.55, 8, 6
