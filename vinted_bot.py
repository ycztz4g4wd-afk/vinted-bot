...
# IMPORTANT :
# Les recherches restent jusqu'à 40 €.
# Cela permet de récupérer des annonces plus chères
# qui servent de comparables.

SEARCH_PRICE_MIN = 0.50
SEARCH_PRICE_MAX = 40.0

# Une opportunité d'achat ne sera analysée que si
# son prix est <= 18 €.
...
def get_comparables(
    ...
    # Aucun price_to ici :
    # les comparables peuvent être plus chers que l'achat.
...
def analyse_item(
    ...
    # RECHERCHE = jusqu'à 40 €
    # ACHAT ANALYSÉ = jusqu'à 18 €.
